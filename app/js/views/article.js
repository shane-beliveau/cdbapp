define([
  ...
  function (Backbone, _, Mustache, iscrollHelper, ArticlesCollection, MyBriefcaseCollection, FullPageAdView, MainTemplate, ArticleContentTemplate, DotsTemplate, Utils) {
    ...
    return Backbone.View.extend({
      ...
      initialize: function (opts) {
        ...
        this.mainView.on('updateLayout', this.checkSwipes, this);
