      ...
      render: function () {
        if (!(this.MostPopularCollection.isFetched &&
          ...
          var _this = this,
            ...
            BlogsFeeds = Mustache.to_html(SingleFeedTemplate, { items: this.BlogsCollection.contentToArray() }),
            TOCFeeds = Mustache.to_html(SingleFeedTemplate, { items: this.TOCCollection.contentToArray() }),
...
//          }
          ...
          */
          ...
          //this.mainView.renderAds(this.$('.ad'), { hasLabel: true, isOffline: this.isOfflineMode }); /* ADS DISABLED HERE */
      ...
      loadBlogs: function (e) {
        ...
        if (article.attr('data-id')) {
          ...
          this.trigger('goToArticle', {
            ...
            model: this.BlogsCollection.where({ id: article.attr('data-id') }),
            storageKey: 'Blogs',
      ...
      loadTOC: function (e) {
        ...
        if (article.attr('data-id')) {
          ...
          this.trigger('goToArticle', {
            ...
            model: this.TOCCollection.where({ id: article.attr('data-id') }),
            storageKey: 'TOC',
